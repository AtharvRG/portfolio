...
const Sparkles: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg role="img" viewBox="0 0 600 600" width="900" height="900" xmlns="http://www.w3.org/2000/svg" {...props}>
    <g transform="translate(0.000000,596.000000) scale(0.100000,-0.100000)">
      <path fill="currentColor" d="M2673 5088 c-5 -7 -19 -49 -32 -93 -193 -678 -692 -1264 -1335 -1569 -106 -50 -218 -93 -361 -139 l-100 -32 -3 -41 c-6 -80 -86 -74 971 -74 837 0 945 2 965 16 l22 15 0 945 c0 633 -3 952 -10 965 -8 15 -21 19 -59 19 -27 0 -53 -5 -58 -12zM3031 5081 c-8 -13 -11 -316 -11 -965 l0 -945 22 -15 c20 -14 128 -16 963 -16 750 0 945 3 959 13 22 16 19 106 -4 117 -8 4 -87 31 -176 59 -506 163 -955 497 -1269 946 -148 212 -234 385 -325 655 l-56 165 -46 3 c-38 2 -49 -1 -57 -17zM852 2908 c-13 -13 -16 -86 -4 -105 4 -7 55 -26 112 -44 295 -87 563 -225 825 -422 106 -81 319 -289 410 -403 205 -254 366 -560 460 -874 14 -46 31 -87 38 -92 22 -14 73 -8 90 10 16 17 17 98 17 965 0 846 -2 947 -16 961 -14 14 -115 16 -968 16 -727 0 -955 -3 -964 -12zM3036 2904 c-14 -14 -16 -115 -16 -964 0 -1058 -6 -980 70 -980 50 0 63 14 85 96 54 208 186 495 319 694 316 476 775 827 1311 1002 88 28 163 57 167 62 12 17 9 81 -4 94 -9 9 -237 12 -964 12 -853 0 -954 -2 -968 -16z"/>
    </g>
  </svg>
);
...
const FlowingRow: React.FC<MenuItemData & { speed?: number }> = ({
  ...
  return (
    <div
      ...
      className="footer-row-anim opacity-0 relative w-full border-t border-white/20 py-8 md:py-12 overflow-hidden cursor-pointer group cursor-target block"
    >
      ...
      <div className="w-full grid grid-cols-2 md:grid-cols-3 px-4 md:px-12 py-8 gap-8 md:gap-0">
        <div className="flex flex-col items-start justify-center">
          ...
          <div className="overflow-hidden">
            <div className="meta-reveal opacity-0 cursor-target flex items-baseline font-sans text-sm md:text-base uppercase tracking-widest text-zinc-300 tabular-nums w-[120px]">
